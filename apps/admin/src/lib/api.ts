...
export async function apiEventGet(token: string, tenantId: string, id: string, mallId?: string): Promise<CmsEvent> {
...
export async function apiEventDelete(token: string, tenantId: string, id: string, mallId?: string): Promise<void> {
...
export async function apiEventPublish(token: string, tenantId: string, id: string, mallId?: string): Promise<CmsEvent> {
...
export async function apiEventArchive(token: string, tenantId: string, id: string, mallId?: string): Promise<CmsEvent> {
